...
namespace Spirebyte.Services.Projects.Core.Entities
{
    public class Project
    {
        ...
        public Project(string id, Guid permissionSchemeId, Guid ownerUserId, IEnumerable<Guid> projectUserIds, IEnumerable<Guid> invitedUserIds, string pic, string title, string description, int issueCount, DateTime createdAt)
        {
