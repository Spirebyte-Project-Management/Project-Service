...
namespace Spirebyte.Services.Projects.Application.Services
{
    public class PermissionService : IPermissionService
    {
        ...
        public PermissionService(IProjectRepository projectRepository, IPermissionSchemeRepository permissionSchemeRepository, IProjectGroupRepository projectGroupRepository, IUserRepository userRepository)
        {
