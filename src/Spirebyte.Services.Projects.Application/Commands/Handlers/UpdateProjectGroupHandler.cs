...
namespace Spirebyte.Services.Projects.Application.Commands.Handlers
{
    internal sealed class UpdateProjectGroupHandler : ICommandHandler<UpdateProjectGroup>
    {
        ...
        public UpdateProjectGroupHandler(IProjectGroupRepository projectGroupRepository, IProjectRepository projectRepository,
        ...
        public async Task HandleAsync(UpdateProjectGroup command)
        {
            ...
            var updatedProjectGroup = new ProjectGroup(projectGroup.Id, projectGroup.ProjectId, projectGroup.Name, command.UserIds);
