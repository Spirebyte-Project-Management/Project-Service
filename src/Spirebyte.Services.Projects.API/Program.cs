        ...
        return WebHost.CreateDefaultBuilder(args)
            ...
            .Configure(app => app
                ...
                .UseDispatcherEndpoints(endpoints => endpoints
                    ...
                    .Post<CreateCustomPermissionScheme>("permissionSchemes",
                        afterDispatch: async (cmd, ctx) => await ctx.Response.Created($"permissionSchemes/{cmd.Id}",
                            await ctx.RequestServices.GetService<IQueryDispatcher>()
                                .QueryAsync<GetPermissionScheme, PermissionSchemeDto>(
                                    new GetPermissionScheme(cmd.Id))))
                    ...
                    .Get<HasPermission, bool>(
                        "projects/{projectId}/user/{userId:guid}/hasPermission/{permissionKey}")
